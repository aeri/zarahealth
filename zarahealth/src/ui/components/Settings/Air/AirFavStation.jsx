...
function AirFavStation() {
  ...
  useEffect(() => {
    if ((data !== undefined && data.currentUser !== null && data.retrieveAllAirStations !== null)) {
                                              ...
                                              {stations.map((station) => {
                                                return (
                                                    <ListItem role="listitem"
                                                      ...
                                                      <ListItemIcon>
                                                        <Checkbox
                                                            checked={station.id === preferredAirStation}
                                                            onChange={() => {
                                                              setPreferredAirStation(station.id)
                                                            }}
                                                            tabIndex={-1}
                                                            disableRipple
                                                        />

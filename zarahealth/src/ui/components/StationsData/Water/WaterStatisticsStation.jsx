...
const GET_WATER_STATION = gql`
    ...
    $endDate: String!,
    $idWaterStation: Int!){
    retrieveWaterStation(startDate: $startDate, endDate:$endDate , idWaterStation:$idWaterStation){
      title
      results{
        creationDate
        result
                                                ...
                                                {({data, loading, error}) => {
                                                    ...
                                                    if (data) {
                                                        ...
                                                        for (const result of results){
                                                            resultsData= results.map((result) => getWaterStatus(result.result));
                                                            if (results.length > timestamps.length) {
                                                                timestamps = results.map((record) => record.creationDate);
                                                            }
                                                        }
